...
function About() {
  ...
  return (
    <>
      <Wrapper id="about">
        ...
        <div className="top">
          <div className="about-left">
            <p>
              We are an ever-growing team of experts coming together to create a
              platform for designers, machinists, communities, artists, and
              donors, to find solutions for solid waste.
            </p>
          </div>
          <div className="about-right">
            <Paragraph>
              We follow the process of recycling from beginning to end, from the
              sorting and collection at household, community, and corporate
              levels, to the final use of the recycled material.
            </Paragraph>
            <Paragraph>
              Our main concern is on how the waste is recycled and how the
              recycling process is in line with the protection of people and the
              environment.
            </Paragraph>
          </div>
        </div>
      ...
      <ModalAbout open={isSolutionOpen} onClose={() => setIsSolutionOpen(false)}>
